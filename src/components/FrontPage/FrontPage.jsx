  ...
  return (
    ...
    '> {/* FRONT-PAGE */}
        ...
        <div className='front-inf'>
          <h2 className='text-body-500 animate__animated animate__flipInX'>Hi! I'm Evelyn Fernández <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24px" height="24px" viewBox="0 0 48 48" >
          ...
          <div className='front-page-inf text-heading  '>
           ...
           <p className='animate__animated animate__slideInRight '>UX-UI design</p>
          </div> 
          </div>
          <div>  {/* TOOLTIPS */} 
